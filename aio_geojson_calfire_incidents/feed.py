...
from .feed_entry import CalfireFeedEntry

_LOGGER = logging.getLogger(__name__)


class CalfireFeed(GeoJsonFeed[CalfireFeedEntry]):
    """Generic GeoJSON feed."""
    ...
    def _new_entry(
        ...
        return CalfireFeedEntry(home_coordinates, feature)

    def _extract_last_timestamp(
        self, feed_entries: List[CalfireFeedEntry]
    ) -> Optional[datetime]:
